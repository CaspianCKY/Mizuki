...
export const siteConfig: SiteConfig = {
	title: "CaspianCKY",
	subtitle: "循此苦旅，终抵繁星",
	siteURL: "https://caspiancky.de5.net/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-12-14", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	font: {
		...
		cjkFont: {
			...
			fontFamily: "霞鹜文楷GB",
			fontWeight: "500",
			localFonts: ["LXGWWenKaiMonoGB-Regular.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/CaspianCKY",
					external: true,
